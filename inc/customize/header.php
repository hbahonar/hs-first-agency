<?php
if (!function_exists('first_agency_customizer_header')) {
    add_action('customize_register', 'first_agency_customizer_header');
    function first_agency_customizer_header($wp_customize)
    {
        ...
        $customizer->AddControl(
            ...
            first_agency_Customizer::$HEADING
        );
...
if (!function_exists('first_agency_customizer_header_style')) {
    add_action('wp_head', 'first_agency_customizer_header_style');
    function first_agency_customizer_header_style()
    {
?>
        <style type="text/css">
            /***header***/
            :root {
                --first-agency-header-background-color: <?php echo esc_attr(get_theme_mod('first_agency_header_bg_color', first_agency_Theme_Class::$headingColor)); ?>;
            ...
            .header-menu .sub-menu li a {
                color: <?php echo esc_attr(get_theme_mod('first_agency_header_menu_submenu_item_color', first_agency_Theme_Class::$headingColor)); ?>;
                background-color: <?php echo esc_attr(get_theme_mod('first_agency_header_menu_submenu_item_bg_color', '#FFFFFF')); ?>;
            }

            .header-menu .sub-menu li a:hover {
                color: <?php echo esc_attr(get_theme_mod('first_agency_header_menu_submenu_item_hover_color', first_agency_Theme_Class::$headingColor)); ?>;
                background-color: <?php echo esc_attr(get_theme_mod('first_agency_header_menu_submenu_item_bg_color', first_agency_Theme_Class::$primaryColorLight)); ?>;
            }
            ...
            @media screen and (max-width:991px) {
                ...
                .header-menu-toggler {
                    color: <?php echo esc_attr(get_theme_mod('first_agency_header_mobile_menu_toggler_color', first_agency_Theme_Class::$secondaryColor)); ?>;
                }

                .header-menu {
                    background-color: <?php echo esc_attr(get_theme_mod('first_agency_header_mobile_menu_bg_color', first_agency_Theme_Class::$headingColor)); ?>;
                }
