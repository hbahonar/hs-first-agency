...
<div id="content" class="">
    <div class="flex flex-wrap lg:flex-nowrap py-[30px]">
        ...
        <div class="w-full lg:w-[<?php echo esc_html($content_width); ?>%] px-[5px] lg:px-[30px]">
            <div class="posts grid gap-[30px] grid-cols-1 lg:grid-cols-<?php echo esc_html(get_theme_mod('first_agency_archive_column_count', '2')); ?>">
                <?php if (have_posts()) : ?>
            ...
            <div class="my-[60px]">
                <?php first_agency_archive_pagination(); ?>
            </div>
        </div>
